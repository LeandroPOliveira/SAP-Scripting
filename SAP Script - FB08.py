...
session.findById("wnd[0]/usr/txtRF05A-GJAHS").text = "2023"
session.findById("wnd[0]/usr/ctxtUF05A-STGRD").text = "02"
session.findById("wnd[0]/usr/ctxtBSIS-BUDAT").text = "01.07.2023"
session.findById("wnd[0]/usr/txtBSIS-MONAT").text = "07"
